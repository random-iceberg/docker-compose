### [Epic A1] CI/CD: Automated Production Docker Build & Registry Publish
...
### [Epic A3] CI/CD: Unit, Integration & E2E Testing Pipeline
...
### [Epic B4] Backend: User Authentication & JWT Issuance
...
### [Epic B5] Database: User Schema Migration & Admin Seeding
...
### [Epic B6] Backend: JWT Middleware & Role‑Based Access Control
...
### [Epic B7] Frontend: AuthContext & Route Guard Hooks
...
### [Epic B8] Frontend: Token Refresh Flow & Session Persistence
...
### [Epic C3] Backend: Pytest Integration Tests for Core Endpoints
...
### [Epic C4] Observability: Structured JSON Logging with Loguru
...
### [Epic C5] Backend: Global Error Handling Middleware
...
### [Epic C6] Backend: User Prediction History Endpoint
...
### [Epic D1] Model-Service: Inference Endpoint with Performance Logging
...
### [Epic D2] Model-Service: Asynchronous Training Endpoint
...
### [Epic D3] Database: Model Registry Schema Migration
...
### [Epic F1] Frontend: Survival Calculator Validation & Mobile Layout
...
### [Epic F2] Frontend: Playwright/Cypress Integration Tests
...
### [Epic F3] Refactor: Code Cleanup & Conventions Enforcement
...
### [Epic F4] Frontend: Extract Shared UI Component Library
...
### [Epic F5] Frontend: Prediction History Dashboard Component
...
### [Epic F6] Frontend: Add Social Sharing Buttons
...
### [Epic G1] Testing: Backend Auth Module Coverage to 100%
...
### [Epic G2] Testing: Model Service Unit & Integration Tests
...
### [Epic G3] Testing: Full E2E Flow with Playwright
...
### [Epic G4] CI/CD: Enforce Coverage Gate & Badge Generation
...
### [Epic H1] Docs: Update Architecture Diagram to RC‑1 Layout
...
### [Epic H2] Docs: RC‑1 Deployment Guide
...
### [Epic H3] Process: Sprint 2 Pull Request Review
...
### [Epic H4] Docs: Prometheus & Grafana Metrics Setup Guide
